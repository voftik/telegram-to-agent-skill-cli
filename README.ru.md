...
¹ chigwell/telegram-mcp, chaindead/telegram-mcp, overpod/mcp-telegram и похожие. Они уместны, когда агент живёт в веб-версии claude.ai, где CLI недоступен; а режим «только черновики» у chaindead придуман по-настоящему безопасно.
